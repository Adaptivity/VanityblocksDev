...
public class mugwater extends ItemFood
{
    public Icon[] icons;
    public String[] textureNames = new String[] { "mugwater" };

    public mugwater(int id, int heal)
    {
    ...
    public void registerIcons (IconRegister iconRegister)
    {
        ...
        {
            this.icons[i] = iconRegister.registerIcon("vanityblocks:mugwater");
        }
    }
}
