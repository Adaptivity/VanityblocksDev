...
//	 * stone brick 7, mossy brick 8, cracked brick 9, circle brick 10, nether brick 11, end stone 12,
    ...
    public void registerBlockIcons(IIconRegister par1IconRegister)
    {
        ...
        iconBuffer[2] = par1IconRegister.registerIcon(Storageprops.sandstonetexture);
        iconBuffer[3] = par1IconRegister.registerIcon("minecraft:brick");
        iconBuffer[4] = par1IconRegister.registerIcon("minecraft:cobblestone_mossy");
        ...
        iconBuffer[8] = par1IconRegister.registerIcon("minecraft:stonebrick_mossy");
        iconBuffer[9] = par1IconRegister.registerIcon("minecraft:stonebrick_cracked");
        iconBuffer[10] = par1IconRegister.registerIcon("minecraft:stonebrick_carved");
        iconBuffer[11] = par1IconRegister.registerIcon("minecraft:nether_brick");
