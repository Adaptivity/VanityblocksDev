...
public class RedstonedimLamps extends BlockRedstoneLight
{
	...
	{
		icons = new IIcon[9];
        icons[0] = par1IconRegister.registerIcon("vanityblocks:redstonelamps/blackLamp");
        icons[1] = par1IconRegister.registerIcon("vanityblocks:redstonelamps/redLamp");
        icons[2] = par1IconRegister.registerIcon("vanityblocks:redstonelamps/greenLamp");
        icons[3] = par1IconRegister.registerIcon("vanityblocks:redstonelamps/brownLamp");
        icons[4] = par1IconRegister.registerIcon("vanityblocks:redstonelamps/blueLamp");
        icons[5] = par1IconRegister.registerIcon("vanityblocks:redstonelamps/purpleLamp");
        icons[6] = par1IconRegister.registerIcon("vanityblocks:redstonelamps/pinkLamp");
        icons[7] = par1IconRegister.registerIcon("vanityblocks:redstonelamps/lightBlueLamp");
        icons[8] = par1IconRegister.registerIcon("vanityblocks:redstonelamps/magentaLamp");
    }
    ...
    public void onNeighborBlockChange(World p_149695_1_, int p_149695_2_, int p_149695_3_, int p_149695_4_, Block p_149695_5_)
    {
        ...
        if (!p_149695_1_.isRemote)
        {
            ...
            {
                p_149695_1_.scheduleBlockUpdate(p_149695_2_, p_149695_3_, p_149695_4_, RedstoneLampRegistrations.RedstoneLampLit, metadata);
            }
