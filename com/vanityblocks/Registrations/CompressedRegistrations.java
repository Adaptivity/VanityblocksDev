...
public class CompressedRegistrations
{
    ...
    public static void compressblockregistration ()
    {
        ...
        /* ##### Vannila ##### */
        GameRegistry.registerBlock(CompressBlocks, CompressItemBlock.class, modid + (CompressBlocks.getUnlocalizedName().substring(2)));
    }

    public static void addRecipes ()
    {
        //Cobble 
        GameRegistry.addRecipe(new ItemStack(CompressBlocks, 1, 0), new Object[] { "xxx", "xxx", "xxx", 'x', new ItemStack(Blocks.cobblestone) });
        GameRegistry.addShapelessRecipe(new ItemStack(Blocks.cobblestone, 9), new ItemStack(CompressBlocks, 1, 0));
        ...
        /* Dirt */
        GameRegistry.addRecipe(new ItemStack(CompressBlocks, 1, 3), new Object[] { "xxx", "xxx", "xxx", 'x', new ItemStack(Blocks.dirt) });
        GameRegistry.addShapelessRecipe(new ItemStack(Blocks.dirt, 9), new ItemStack(CompressBlocks, 1, 3));
        ...
        /* Sand */
        GameRegistry.addRecipe(new ItemStack(CompressBlocks, 1, 6), new Object[] { "xxx", "xxx", "xxx", 'x', new ItemStack(Blocks.sand) });
        GameRegistry.addShapelessRecipe(new ItemStack(Blocks.sand, 9), new ItemStack(CompressBlocks, 1, 6));
        ...
        /* Gravel */
        GameRegistry.addRecipe(new ItemStack(CompressBlocks, 1, 9), new Object[] { "xxx", "xxx", "xxx", 'x', new ItemStack(Blocks.gravel) });
        GameRegistry.addShapelessRecipe(new ItemStack(Blocks.gravel, 9), new ItemStack(CompressBlocks, 1, 9));
