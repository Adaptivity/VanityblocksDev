...
public class StorageBlocksRegistration
{
    ...
    public static void blockregistration ()
    {
        ...
        //String[] vannilastorageBlockNames = { "Sugar Cane Block", "Charcoal Block", "Enderpearl Block", "Slime Block", "Sugar Block", "Cocoa Block", "", "Leather Block", "Bone Block", "", "", "" };
        //String[] modstorageBlockNames = { "Tin Block", "Copper Block", "Silver Block", "Lead Block", "Nikolite Block", "Nickel Block", "Electrum Block", "Platinum Block", "Invar Block",
         //       "Brass Block", "Rubber Block", "", "" };
        //String[] forestrystorageBlockNames = { "Apatitde Block", "Honey Block", "Honeydew Block", "Peat Block", "", "", "", "", "", "", "", "" };
        /* ##### Vannila ##### */
        GameRegistry.registerBlock(StorageBlock, StorageItemBlock.class, modid + (StorageBlock.getUnlocalizedName().substring(0)));
        /* ########### Modded #### */
        GameRegistry.registerBlock(StorageBlockMod, StorageItemModBlock.class, modid + (StorageBlockMod.getUnlocalizedName().substring(1)));;
    }
    ...
    public static void addVanillaRecipes ()
    {
        ...
        {
            GameRegistry.addRecipe(new ItemStack(StorageBlock, 1, 0), "xxx", "xxx", "xxx", 'x', new ItemStack(Items.coal, 1, 1));
            GameRegistry.addShapelessRecipe(new ItemStack(Items.coal, 9, 1), new ItemStack(StorageBlock, 1, 0));
        ...
        {
            GameRegistry.addRecipe(new ItemStack(StorageBlock, 1, 1), "xxx", "xxx", "xxx", 'x', new ItemStack(Items.ender_pearl));
            GameRegistry.addShapelessRecipe(new ItemStack(Items.ender_pearl, 9), new ItemStack(StorageBlock, 1, 1));
            if (Storageprops.gregtechcompat)
            {
        ...
        if (Storageprops.enableenderpearl)
        {
            ...
            {
                GameRegistry.addRecipe(new ItemStack(Blocks.dragon_egg, 1), new Object[] { "xxx", "xyx", "xxx", 'x', new ItemStack(StorageBlock, 1, 1), 'y', Items.egg });
            }
        }
        if (Storageprops.enablesugar)
        {
            GameRegistry.addRecipe(new ItemStack(StorageBlock, 1, 2), "xxx", "xxx", "xxx", 'x', new ItemStack(Items.sugar));
            GameRegistry.addShapelessRecipe(new ItemStack(Items.sugar, 9), new ItemStack(StorageBlock, 1, 2));
            if (Storageprops.gregtechcompat)
            {
                OreDictionary.registerOre("blockSugar", new ItemStack(StorageBlock, 1, 2));
            }
        }
        if (Storageprops.enablecocoa)
        {
            GameRegistry.addRecipe(new ItemStack(StorageBlock, 1, 3), "xxx", "xxx", "xxx", 'x', new ItemStack(Items.dye, 1, 3));
            GameRegistry.addShapelessRecipe(new ItemStack(Items.dye, 9, 3), new ItemStack(StorageBlock, 1, 3));
            if (Storageprops.gregtechcompat)
            {
                OreDictionary.registerOre("blockCocoa", new ItemStack(StorageBlock, 1, 3));
            }
        }
        if (Storageprops.enablesugarcane)
        {
            GameRegistry.addRecipe(new ItemStack(StorageBlock, 1, 4), "xxx", "xxx", "xxx", 'x', new ItemStack(Items.reeds));
            GameRegistry.addShapelessRecipe(new ItemStack(Items.reeds, 9), new ItemStack(StorageBlock, 1, 4));
            if (Storageprops.gregtechcompat)
            {
                OreDictionary.registerOre("blockSugarCane", new ItemStack(StorageBlock, 1, 4));
            }
        }
        if (Storageprops.enableleather)
        {
            GameRegistry.addRecipe(new ItemStack(StorageBlock, 1, 5), new Object[] { "xxx", "xxx", "xxx", 'x', new ItemStack(Items.leather) });
            GameRegistry.addShapelessRecipe(new ItemStack(Items.leather, 9), new ItemStack(StorageBlock, 1, 5));
            if (Storageprops.gregtechcompat)
            {
                OreDictionary.registerOre("blockLeather", new ItemStack(StorageBlock, 1, 5));
            }
        }
        if (Storageprops.enablebone)
        {
            GameRegistry.addRecipe(new ItemStack(StorageBlock, 1, 6), new Object[] { "xxx", "xxx", "xxx", 'x', new ItemStack(Items.bone) });
            GameRegistry.addShapelessRecipe(new ItemStack(Items.bone, 9), new ItemStack(StorageBlock, 1, 6));
            if (Storageprops.gregtechcompat)
            {
                OreDictionary.registerOre("blockBone", new ItemStack(StorageBlock, 1, 6));
            }
        }
    }
    ...
    public static void addForestryRecipes ()
    {
        ...
        //{
            try
            {
                GameRegistry.registerBlock(ForestryBlock, StorageItemForestryBlock.class, "ForestryStorage Block");
