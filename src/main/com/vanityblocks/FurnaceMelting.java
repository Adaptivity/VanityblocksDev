...
public class FurnaceMelting
{
    ...
    public static void addFurnaceMelts ()
    {
        ...
        {
            GameRegistry.addSmelting(Items.bucket, new ItemStack(Items.iron_ingot, 2), 0.0F);
            ...
            GameRegistry.addSmelting(Blocks.anvil, new ItemStack(Items.iron_ingot, 30), 0.0F);
            GameRegistry.addSmelting(Blocks.hopper, new ItemStack(Items.iron_ingot, 5), 0.0F);
			GameRegistry.addSmelting(Items.iron_sword, new ItemStack(Items.iron_ingot), 0.0f);
            GameRegistry.addSmelting(Items.iron_pickaxe, new ItemStack(Items.iron_ingot, 3), 0.0F);
            GameRegistry.addSmelting(Items.iron_shovel, new ItemStack(Items.iron_ingot, 2), 0.0F);
            ...
            GameRegistry.addSmelting(Items.golden_shovel, new ItemStack(Items.gold_ingot, 2), 0.0F);
