...
public class GeneralItemRegistration
{
    ...
    public static void generalitemregistration ()
    {
        ...
        {
            coalstorageitem = new coalstorageitem(Storageprops.coalstorageitem - 256);
        	GameRegistry.registerItem(coalstorageitem, "coalstorageitem");

        }
        if (Storageprops.enablearrowstorageitem)
        {
            arrowstorageitem = new arrowstorageitem(Storageprops.arrowstorageitem - 256);
        	GameRegistry.registerItem(arrowstorageitem, "arrowstorageitem");
        }
        if (Storageprops.enableblazestorageitem)
        {
            blazestorageitem = new blazestorageitem(Storageprops.blazestorageitem - 256);
    ...
    public static void additemrecipes ()
    {
        ...
        if (Storageprops.enableflintitem)
        {
            ...
            GameRegistry.addRecipe(new ItemStack(flintitem, 1), "xxx", "xxx", "xxx", 'x', new ItemStack(Items.flint, 1));
            GameRegistry.addShapelessRecipe(new ItemStack(Items.flint, 9), new ItemStack(flintitem));
        }
        if (Storageprops.enablecoalstorageitem)
        {
            GameRegistry.addRecipe(new ItemStack(coalstorageitem, 1), "xxx", "x x", "xxx", 'x', new ItemStack(Items.coal, 1));
            GameRegistry.addShapelessRecipe(new ItemStack(Items.coal, 8), new ItemStack(coalstorageitem));
        }
        if (Storageprops.enablearrowstorageitem)
        {
            GameRegistry.addRecipe(new ItemStack(arrowstorageitem, 1), "xxx", "xxx", "xxx", 'x', new ItemStack(Items.arrow, 1));
            GameRegistry.addShapelessRecipe(new ItemStack(Items.arrow, 9), new ItemStack(arrowstorageitem));
        }
        if (Storageprops.enableblazestorageitem)
        {
            GameRegistry.addRecipe(new ItemStack(blazestorageitem, 1), new Object[] { "xxx", "xxx", "xxx", 'x', new ItemStack(Items.blaze_rod) });
            GameRegistry.addShapelessRecipe(new ItemStack(Items.blaze_rod, 9), new ItemStack(blazestorageitem));
        }
    }
}