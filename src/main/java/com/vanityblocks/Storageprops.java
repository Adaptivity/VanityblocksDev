...
public class Storageprops {
	public static void initProps(File configBase) {
		 ...
		 * config.getBlock(blocks, "Vanityblocks trapdoors id",
		 * 3049).getInt(3049); storageblockconfig = config.getBlock(blocks,
		 * "Vannila Storage Blocks ID", 3050).getInt(3050);
		 * storageblockmodconfig = config.getBlock(blocks,
		 * "Modded Storage Blocks ID", 3051).getInt(3051); forestryblockconfig =
		 * config.getBlock(blocks, "Forestry Storage Blocks ID",
		 * 3053).getInt(3053); vanitydesignconfig = config.getBlock(blocks,
		 * "Vanity design blocks ID", 3055).getInt(3055); redstonelampdimconfig
		 * = config.getBlock(blocks, "Redstone Lamp Dim Id", 3056).getInt(3056);
		 * redstonelamplitconfig = config.getBlock(blocks,
		 * "Redstone lamp Lit id", 3057).getInt(3057); vanitydesignworldconfig =
		 * config.getBlock(blocks, "Vanity Blocks World Generation block ID",
		 * 3058).getInt(3058); vanityentityconfig = config.getBlock(blocks,
		 * "Vanity Blocks Tile Entity(such as melting core) ID",
		 * 3060).getInt(3058); vanitydesignworldslabconfig =
		 * config.getBlock(blocks, "Vanity Blocks World Gen slabs ID",
		 * 3061).getInt(3061); vanitydesignworldWallconfig =
		 * config.getBlock(blocks, "Vanity Blocks World Gen walls ID",
		 * 3062).getInt(3062); curtainblockconfig = config.get(blocks,
		 * "Vanity Curtain Id", 3063).getInt(3063); randomblocksconfig =
		 * config.getBlock(blocks, "Vanityblocks random blocks id",
		 * 3064).getInt(3064); compressblocksconfig = config.getBlock(blocks,
		 * "Common Compressed Blocks ID", 3066).getInt(3066); //
		 * vanityfenceconfig = config.getBlock(blocks, // "Vanity Fences",
		 * 3065).getInt(3065);
		 */

		/*
		 * String blockstairs = "Marble Stair id's"; marblestair =
		 * config.get(blockstairs, "Marble Stair id", 3038).getInt(3038);
		 * marblebrickstair = config.get(blockstairs, "Marble Brick Stair id",
		 * 3039).getInt(3039); marblepillarstair = config.get(blockstairs,
		 * "Marble Pillar Stair id", 3040).getInt(3040); marbletilestair =
		 * config.get(blockstairs, "Marble Tile Stair id", 3041).getInt(3041);
		 * blackmarblestair = config.get(blockstairs,
		 * "Ashford Black Marble Stair id", 3042).getInt(3042);
		 * blackmarblebrickstair = config.get(blockstairs,
		 * "Ashford Black Marble Brick Stair id", 3043).getInt(3043);
		 * blackmarblepillarstair = config.get(blockstairs,
		 * "Ashford Black Marble Pillar Stair id", 3044).getInt(3044);
		 * blackmarbletilestair = config.get(blockstairs,
		 * "Ashford Black Marble Tile Stair id", 3045).getInt(3045);
		 */
		/*
		 * String items = "Item id's"; // config.getItem("Patterns and Misc",
		 * "Tinker's Manual", // 14018).getInt(14018); use a second "" to add it
		 * to a sub category greenrupee1 = config.getItem(items,
		 * "Green Rupee - 1 Rupees", 19000).getInt(19000); bluerupee5 =
		 * config.getItem(items, "Blue Rupee - 5 Rupees", 19001).getInt(19001);
		 * redrupee20 = config.getItem(items, "Red Rupee - 20 Rupees",
		 * 19002).getInt(19002); biggreenrupee50 = config.getItem(items,
		 * "Big Green Rupee - 50 Rupees", 19003).getInt(19003); bigbluerupee100
		 * = config.getItem(items, "Big Blue Rupee - 100 Rupees",
		 * 19004).getInt(19004); bigredrupee200 = config.getItem(items,
		 * "Big Red Rupee - 200 Rupees", 19005).getInt(19005);
		 */
		...
		coalstorageitem = config.get(generalitems, "Coal Storage Item Id",
				19009).getInt(19009);
		enableflintitem = config.get(generalitems, "Enable Flint Item?", true)
				.getBoolean(true);
		flintitem = config.get(generalitems, "Flint Storage Item Id", 19010)
				.getInt(19010);
		...
		/*
		 * String generalfooditems = "General Food Item Config"; mugunfired =
		 * config.get(generalfooditems, "Unfired Mug Id", 19020).getInt(19020);
		 * emptymug = config.get(generalfooditems, "Empty Mug Id",
		 * 19021).getInt(19021); mugwater = config.get(generalfooditems,
		 * "Mug with Water Id", 19022).getInt(19022); mugwaterhot =
		 * config.get(generalfooditems, "Mug with hot water Id",
		 * 19023).getInt(19023); mugwaterhotchoco = config.get(generalfooditems,
		 * "Hot Chocolate with water Id", 19024).getInt(19024);
		 * mugwaterhotchocosugar = config.get(generalfooditems,
		 * "Sweetend Hot Chocolate with water Id", 19025).getInt(19025); mugmilk
		 * = config.get(generalfooditems, "Mug with milk Id",
		 * 19026).getInt(19026); mugmilkhot = config.get(generalfooditems,
		 * "Mug with hot milk Id", 19027).getInt(19027); mugmilkhotchoco =
		 * config.get(generalfooditems, "Hot Chocolate with milk Id",
		 * 19028).getInt(19028); mugmilkhotchocosugar =
		 * config.get(generalfooditems, "Sweetend Hot Chocolate with milk Id",
		 * 19029).getInt(19029);
		 */
		...
		// "Allow Underwater Ruins to generate?", true).getBoolean(true);
		 ruinchance = config.get(category7, "One in how many chance of the ruins to generate. Such as 20 will make it a 1 in 20, play in ssp to find a good value(i suggest 150+)",5).getInt();
		...
		sandstonetexture = config
				.get(category10,
						"Want to use different peice of sandstone texture for the smooth sandstone pillar, use minecraft:texturenamehere",
						"minecraft:sandstone_smooth").getString();

		// String miningdimension = "Mining Dimension Related";
		// enableminingworld = config.get(miningdimension,
		// "This will enable or disable all of the Mining dimension portion(Check the other config for values)",
		// false).getBoolean(false);
		config.save();
	}

	/*
	 * public static void dimensionconfig (File configBase) { Configuration
	 * config = new Configuration(new File(configBase,
	 * DefaultProps.FILE_CONFIGDIMENSION));
	 * 
	 * config.load();
	 * 
	 * String miningdimension = "Mining Dimension Related"; vanityportalID =
	 * config.get(miningdimension, "Vanity Mining world Portal ID",
	 * 3035).getInt(3035); portalstarterID = config.get(miningdimension,
	 * "Vanity Mining World Portal Lighter ID", 19008).getInt(19008); vmrespawn
	 * = config.get(miningdimension, "Allow respawn in the mining dimensions?",
	 * false).getBoolean(false); vmhostile = config.get(miningdimension,
	 * "Allow Hostile Mobs to spawn in the dimensions?(sets to all dimensions)",
	 * true).getBoolean(true); vmpassive = config.get(miningdimension,
	 * "Allow Passive mobs to spawn in the dimensions?(sets to all dimensions)",
	 * true).getBoolean(true); // vmtpcmd = config.get(miningdimension,
	 * "Allow ops to teleport to other dimensions?", true).getBoolean(true);
	 * 
	 * String miningdimensionids = "Mining Dimension ID's"; //VanityMiningID =
	 * config.get(miningdimensionids, "This is the Vanity Mining World ID",
	 * 255).getInt(255); vmplainsid = config.get(miningdimensionids,
	 * "Vanity Dimension Plains World ID", 255).getInt(255); vmdeserthillsid =
	 * config.get(miningdimensionids, "Vanity Dimension Desert Hills World ID",
	 * 253).getInt(253); vmextremehillsid = config.get(miningdimensionids,
	 * "Vanity Dimension Extreme Hills World ID", 252).getInt(252); vmforestid =
	 * config.get(miningdimensionids, "Vanity Dimension Forest World ID",
	 * 251).getInt(251); vmtaigaid = config.get(miningdimensionids,
	 * "Vanity Dimension Taiga World ID", 250).getInt(250); vmswamplandid =
	 * config.get(miningdimensionids, "Vanity Dimension Swampland World ID",
	 * 249).getInt(249); vmhellid = config.get(miningdimensionids,
	 * "Vanity Dimension Hell World ID", 248).getInt(248); vmshroomislandid =
	 * config.get(miningdimensionids, "Vanity Dimension Shroom World ID",
	 * 247).getInt(247); vmjungleid = config.get(miningdimensionids,
	 * "Vanity Dimension Jungle World ID", 246).getInt(246);
	 * 
	 * String miningdimensionsenable = "Mining Dimensions Enabled";
	 * vmenableplains = config.get(miningdimensionsenable,
	 * "Enable the Plains mining dimension?", true).getBoolean(true);
	 * vmenabledeserthills = config.get(miningdimensionsenable,
	 * "Enable the Desert Hills mining dimension?", true).getBoolean(true);
	 * vmenableextremehills = config.get(miningdimensionsenable,
	 * "Enable the Extremehills mining dimension?", true).getBoolean(true);
	 * vmenableforest = config.get(miningdimensionsenable,
	 * "Enable the Forest mining dimension?", true).getBoolean(true);
	 * vmenabletaiga = config.get(miningdimensionsenable,
	 * "Enable the Taiga mining dimension?", true).getBoolean(true);
	 * vmenableswampland = config.get(miningdimensionsenable,
	 * "Enable the Swampland mining dimension?", true).getBoolean(true);
	 * vmenablehell = config.get(miningdimensionsenable,
	 * "Enable the Hell mining dimension?", true).getBoolean(true);
	 * vmenableshroom = config.get(miningdimensionsenable,
	 * "Enable the Shroom mining dimension?", true).getBoolean(true);
	 * vmenablejungle = config.get(miningdimensionsenable,
	 * "Enable the Jungle mining dimension?", true).getBoolean(true);
	 * 
	 * config.save(); }
	 */
	...
	// Random Texture related
	public static String sandstonetexture;

	// Mining Dimension Related
	public static boolean enableminingworld;
	public static int VanityMiningID;
	...
	public static int vmextremehillsid;
	public static int vmforestid;
	public static int vmtaigaid;
	public static int vmswamplandid;
	public static int vmhellid;
	public static int vmshroomislandid;
	public static int vmjungleid;
	// Dimensions enabled?
	public static boolean vmenableplains;
	public static boolean vmenabledeserthills;
	public static boolean vmenableextremehills;
	public static boolean vmenableforest;
	public static boolean vmenabletaiga;
	public static boolean vmenableswampland;
	public static boolean vmenablehell;
	public static boolean vmenableshroom;
	public static boolean vmenablejungle;
}
