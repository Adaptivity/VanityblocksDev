...
public class RedstonedimLamps extends BlockRedstoneLight
{
    ...
    public void registerIcons (IconRegister par1IconRegister)
    {
        ...
        iconBuffer[0] = par1IconRegister.registerIcon("vanityblocks:redstonelamps/blackLamp");
        iconBuffer[1] = par1IconRegister.registerIcon("vanityblocks:redstonelamps/redLamp");
        iconBuffer[2] = par1IconRegister.registerIcon("vanityblocks:redstonelamps/greenLamp");
        iconBuffer[3] = par1IconRegister.registerIcon("vanityblocks:redstonelamps/brownLamp");
        iconBuffer[4] = par1IconRegister.registerIcon("vanityblocks:redstonelamps/blueLamp");
        iconBuffer[5] = par1IconRegister.registerIcon("vanityblocks:redstonelamps/purpleLamp");
        iconBuffer[6] = par1IconRegister.registerIcon("vanityblocks:redstonelamps/pinkLamp");
        iconBuffer[7] = par1IconRegister.registerIcon("vanityblocks:redstonelamps/lightBlueLamp");
        iconBuffer[8] = par1IconRegister.registerIcon("vanityblocks:redstonelamps/magentaLamp");
    }
