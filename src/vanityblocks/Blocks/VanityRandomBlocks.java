...
public class VanityRandomBlocks extends Block
{
    ...
    public void registerIcons (IconRegister par1IconRegister)
    {
        ...
        iconBuffer[1] = par1IconRegister.registerIcon("vanityblocks:whitesoulsand");
        iconBuffer[2] = par1IconRegister.registerIcon("vanityblocks:oldlapisblock");
        iconBuffer[3] = par1IconRegister.registerIcon("vanityblocks:oldlapisbrick");
        iconBuffer[4] = par1IconRegister.registerIcon("vanityblocks:lapisbrick");
    }
