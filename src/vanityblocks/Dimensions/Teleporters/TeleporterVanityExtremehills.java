...
import vanityblocks.Dimensions.PortalPositions.VanityPortalPositionsExtremeHills;
...
public class TeleporterVanityExtremehills extends Teleporter
{
    ...
    public TeleporterVanityExtremehills(WorldServer par1WorldServer)
    {
    ...
    public boolean placeInExistingPortal (Entity par1Entity, double par2, double par4, double par6, float par8)
    {
        ...
        if (d3 >= 0.0D)
        {
            if (flag)
            {
                this.field_85191_c.add(j1, new VanityPortalPositionsExtremeHills(this, i, j, k, this.worldServerInstance.getTotalWorldTime()));
