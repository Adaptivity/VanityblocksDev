...
import vanityblocks.Dimensions.PortalPositions.VanityPortalPositionsJungle;
...
public class TeleporterVanityJungle extends Teleporter
{
    ...
    public TeleporterVanityJungle(WorldServer par1WorldServer)
    {
    ...
    public boolean placeInExistingPortal (Entity par1Entity, double par2, double par4, double par6, float par8)
    {
        ...
        if (d3 >= 0.0D)
        {
            if (flag)
            {
                this.field_85191_c.add(j1, new VanityPortalPositionsJungle(this, i, j, k, this.worldServerInstance.getTotalWorldTime()));
        ...
        for (k2 = 0; k2 < 4; ++k2)
        {
            for (i3 = 0; i3 < 4; ++i3)
            {
                for (l2 = -1; l2 < 4; ++l2)
                {
                    ...
                    this.worldServerInstance.setBlock(k3, j3, i4, flag ? Block.stone.blockID : MiningWorldRegistrations.vanityportal.blockID, 7, 2);
                }
            }
