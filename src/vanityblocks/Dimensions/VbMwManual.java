...
public class VbMwManual extends ItemBlock
{
    ...
    static
    {
        System.out.println("book nbt loaded");
        ...
        //pages.appendTag(new NBTTagString("3", "This section will teach you how to make the portal shapes. Top Layer is a Lapis Block. \n Second Layer is.. \n  X \n X X \n  X \n  Keep in mind the top layer block is in the middle of the second layer up 1. \n The Third Layer is..  "));
        pages.appendTag(new NBTTagString("3", "This section will teach you how to make the portal shapes. You can see the design here(hard to explain) \n http://imgur.com/a/uKxAL \n The structure is always in that shape except for the hell dimension. "));
        pages.appendTag(new NBTTagString("4", "Note the middle block in that structures bottom(the grass block(Redstone Ready world so discolored) \n Anyways, its the identifier, on the next page is biome name and its identifier block to open the portal there. \n (Lapis Block is always Required at top cept for hell)"));
        pages.appendTag(new NBTTagString("5", "The possible dimensions are.. \n Plains - Grass Block \n Desert Hills - Sandstone Block \n Extreme Hills - Emerald Block \n Forest - Any Wood Log(Vannila)(direction doesnt matter) \n Taiga - Snow Block \n  Cont -> Next Page"));
        pages.appendTag(new NBTTagString("6", "Swampland - Clay Block \n Shroom Island - Mycelium \n Jungle - Any leaves(Vannila) \n For the hell dimension its a bit different. All the stone is netherbrick and the lapis/identifer blocks are normal Nether Quartz Blocks."));
        pages.appendTag(new NBTTagString("7", "Then you right click with the lighter on the identifier block and the portals spawn, viola :) Enjoy. Please report any bugs you find, this was alot of work and effort for me."));
        pages.appendTag(new NBTTagString("7", "      Credits\nThanks to RebelKeithy for making Atum. Helped alot. \n\nThanks to mDiyo for help here and there. \n\nThanks to Kodos for helping with ideas/testing."));
