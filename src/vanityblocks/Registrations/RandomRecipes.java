...
public class RandomRecipes
{
    public static void addRandomRecipes ()
    {
        ...
        {
            GameRegistry.addShapelessRecipe(new ItemStack(Item.nameTag, 1), new ItemStack(Item.sign), new ItemStack(Item.silk));
        }
        if (Storageprops.ironhorsearmor)
        {
            GameRegistry.addRecipe(new ItemStack(Item.horseArmorIron, 1), "xxx", "xxx", "x x", 'x', new ItemStack(Item.ingotIron));
        }
        if (Storageprops.goldhorsearmor)
        {
            GameRegistry.addRecipe(new ItemStack(Item.horseArmorGold, 1), "xxx", "xxx", "x x", 'x', new ItemStack(Item.ingotGold));
        }
        if (Storageprops.diamondhorsearmor)
        {
            GameRegistry.addRecipe(new ItemStack(Item.horseArmorDiamond, 1), "xxx", "xxx", "x x", 'x', new ItemStack(Item.diamond));
        }
    }
}