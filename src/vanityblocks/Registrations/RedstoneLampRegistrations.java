...
public class RedstoneLampRegistrations
{
    ...
    public static void addRecipes ()
    {
        ...
        GameRegistry.addShapelessRecipe(new ItemStack(RedstoneLampDim, 1, 0), new ItemStack(Block.redstoneLampIdle), new ItemStack(Item.dyePowder, 1, 0));
        // Recipes for Red Lamp
        GameRegistry.addShapelessRecipe(new ItemStack(RedstoneLampDim, 1, 1), new ItemStack(Block.redstoneLampIdle), new ItemStack(Item.dyePowder, 1, 1));
        // Recipes For Green Lamp
        GameRegistry.addShapelessRecipe(new ItemStack(RedstoneLampDim, 1, 2), new ItemStack(Block.redstoneLampIdle), new ItemStack(Item.dyePowder, 1, 2));
        // Recipes for Brown Lamp
        GameRegistry.addShapelessRecipe(new ItemStack(RedstoneLampDim, 1, 3), new ItemStack(Block.redstoneLampIdle), new ItemStack(Item.dyePowder, 1, 3));
        // Recipes for Blue Lamp
        GameRegistry.addShapelessRecipe(new ItemStack(RedstoneLampDim, 1, 4), new ItemStack(Block.redstoneLampIdle), new ItemStack(Item.dyePowder, 1, 4));
        // Recipes for Purple Lamp
        GameRegistry.addShapelessRecipe(new ItemStack(RedstoneLampDim, 1, 5), new ItemStack(Block.redstoneLampIdle), new ItemStack(Item.dyePowder, 1, 5));
        // Recipes for Pink Lamp
        GameRegistry.addShapelessRecipe(new ItemStack(RedstoneLampDim, 1, 6), new ItemStack(Block.redstoneLampIdle), new ItemStack(Item.dyePowder, 1, 9));
        // Recipes for Light Blue Lamp
        GameRegistry.addShapelessRecipe(new ItemStack(RedstoneLampDim, 1, 7), new ItemStack(Block.redstoneLampIdle), new ItemStack(Item.dyePowder, 1, 12));
        // Recipes for Magenta Lamp
        GameRegistry.addShapelessRecipe(new ItemStack(RedstoneLampDim, 1, 8), new ItemStack(Block.redstoneLampIdle), new ItemStack(Item.dyePowder, 1, 13));
    }
