...
public class StorageBlocksRegistration
{
    ...
    public static void blockregistration ()
    {
        ...
        String[] forestrystorageBlockNames = { "Apatite Block", "Honey Block", "Honeydew Block", "Peat Block", "", "", "", "", "", "", "", "" };
        /* ##### Vannila ##### */
        GameRegistry.registerBlock(StorageBlock, vanityblocks.ItemBlocks.StorageItemBlock.class, "Vannila Storage Block");
        ...
        LanguageRegistry.addName(new ItemStack(StorageBlock, 1, 6), "Leather Block");
        LanguageRegistry.addName(new ItemStack(StorageBlock, 1, 7), "Bone Block");
        /* ########### Modded #### */
        GameRegistry.registerBlock(StorageBlockMod, vanityblocks.ItemBlocks.StorageItemModBlock.class, "Modded Storage Block");
    ...
    public static void addVanillaRecipes ()
    {
        ...
        {
            GameRegistry.addRecipe(new ItemStack(StorageBlock, 1, 6), new Object[] { "xxx", "xxx", "xxx", 'x', new ItemStack(Item.leather) });
            GameRegistry.addShapelessRecipe(new ItemStack(Item.leather, 9), new ItemStack(StorageBlock, 1, 6));
            if (Storageprops.gregtechcompat)
            {
        ...
        {
            GameRegistry.addRecipe(new ItemStack(StorageBlock, 1, 7), new Object[] { "xxx", "xxx", "xxx", 'x', new ItemStack(Item.bone) });
            GameRegistry.addShapelessRecipe(new ItemStack(Item.bone, 9), new ItemStack(StorageBlock, 1, 7));
            if (Storageprops.gregtechcompat)
            {
    ...
    public static void addForestryRecipes ()
    {
        if (Loader.isModLoaded("Forestry"))
        {
            try
            {
                GameRegistry.registerBlock(ForestryBlock, vanityblocks.ItemBlocks.StorageItemForestryBlock.class, "ForestryStorage Block");
