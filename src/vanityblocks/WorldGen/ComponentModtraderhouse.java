...
public class ComponentModtraderhouse extends ComponentVillage
{
    ...
    public ComponentModtraderhouse(ComponentVillageStartPiece par1ComponentVillageStartPiece, int par2, Random par3Random, StructureBoundingBox par4StructureBoundingBox, int par5)
    {
    ...
    public boolean addComponentParts (World par1World, Random par2Random, StructureBoundingBox par3StructureBoundingBox)
    {
        ...
        this.placeBlockAtCurrentPosition(par1World, Block.stoneBrick.blockID, 0, 6, 0, 6, par3StructureBoundingBox);
        this.fillWithBlocks(par1World, par3StructureBoundingBox, 2, 1, 6, 2, 1, 10, Block.netherFence.blockID, Block.netherFence.blockID, false);
        this.fillWithBlocks(par1World, par3StructureBoundingBox, 8, 1, 6, 8, 1, 10, Block.netherFence.blockID, Block.netherFence.blockID, false);
        this.fillWithBlocks(par1World, par3StructureBoundingBox, 3, 1, 10, 7, 1, 10, Block.netherFence.blockID, Block.netherFence.blockID, false);
        this.fillWithBlocks(par1World, par3StructureBoundingBox, 1, 0, 1, 7, 0, 4, Block.planks.blockID, Block.planks.blockID, false);
        this.fillWithBlocks(par1World, par3StructureBoundingBox, 0, 0, 0, 0, 3, 5, Block.stoneBrick.blockID, Block.stoneBrick.blockID, false);
        this.fillWithBlocks(par1World, par3StructureBoundingBox, 8, 0, 0, 8, 3, 5, Block.stoneBrick.blockID, Block.stoneBrick.blockID, false);
        this.fillWithBlocks(par1World, par3StructureBoundingBox, 1, 0, 0, 7, 1, 0, Block.stoneBrick.blockID, Block.stoneBrick.blockID, false);
        this.fillWithBlocks(par1World, par3StructureBoundingBox, 1, 0, 5, 7, 1, 5, Block.stoneBrick.blockID, Block.stoneBrick.blockID, false);
        ...
        this.placeBlockAtCurrentPosition(par1World, Block.netherFence.blockID, 0, 2, 1, 3, par3StructureBoundingBox);
        ...
        for (k = 0; k < 5; ++k)
        {
            for (l = 0; l < 9; ++l)
            {
                ...
                this.fillCurrentPositionBlocksDownwards(par1World, Block.stoneBrick.blockID, 0, l, -1, k, par3StructureBoundingBox);
            }
        }
