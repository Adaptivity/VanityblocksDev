    ...
    { 
        ...
        { 
            ...
            { 
                ...
                world.setBlock(j1, k1 - j5 - k4, l1 + 2, Block.blockIron.blockID); 
                ...
                if(k7 <= 30) 
                { 
                    world.setBlock(j1 + l3, k1 - j5 - i6 - k4, l1 + l3 + 5, Block.blockGold.blockID); 
                ...
                if(k7 <= 60) 
                { 
                    world.setBlock(j1 - i3 - 1, k1 - j5 - i6 - k4, l1 - 5, Block.blockIron.blockID); 
            ...
            { 
                ...
                world.setBlock(j1, k1 - k5 - l4, l1 + 2, Block.blockIron.blockID); 
                ...
                if(l7 <= 30) 
                { 
                    world.setBlock(j1 - k2 - 1, k1 - k5 - j6 - l4, l1 - 5, Block.blockGold.blockID); 
                ...
                if(l7 <= 60) 
                { 
                    world.setBlock(j1 + i4, k1 - k5 - j6 - l4, l1 + 7, Block.blockIron.blockID); 
                ...
                if(l7 <= 30) 
                { 
                    world.setBlock(j1 - j3, k1 - k5 - j6 - l4, (l1 + i4) - 2, Block.blockGold.blockID); 
                ...
                if(l7 <= 30) 
                { 
                    world.setBlock(j1 + j3 + 4, k1 - k5 - j6 - l4, l1 - 7, Block.blockGold.blockID); 
            ...
            world.setBlock(j1, k1 - l5 - i5, l1 + 1, Block.blockIron.blockID); 
            ...
            if(i8 <= 30) 
            { 
                world.setBlock(j1 + k3 + l2, k1 - l5 - k6 - i5, l1 + j4 + 1, Block.blockGold.blockID); 
            ...
            if(i8 <= 60) 
            { 
                world.setBlock(j1 - k3 - 1, k1 - l5 - k6 - i5, l1 - l2 - 6, Block.blockIron.blockID); 
            ...
            if(i8 <= 30) 
            { 
                world.setBlock(j1 + l2 + 2, k1 - l5 - k6 - i5, l1 + j4, Block.blockGold.blockID); 
            ...
            if(i8 <= 30) 
            { 
                world.setBlock(j1 - 3, k1 - l5 - k6 - i5, l1 + k3 + 3, Block.blockGold.blockID); 
